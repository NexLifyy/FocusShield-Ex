const FOCUSSHIELD_CONFIG = {
  ...
  // If false, FocusShield runs in a mock cloud authentication and sync mode.
  useLiveCloudDb: true,
  supabaseUrl: 'https://evmbcpinujaufvwcxaaa.supabase.co',
  supabaseAnonKey: 'sb_publishable_FwqzwLUMWBAAmp6IG75ocQ_0BbOqr_D'
};
